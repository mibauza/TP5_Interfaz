...
export class HomeComponent {
  elementos = [
    ...
    { img: '../../assets/animales/img4.jpg', texto: 'Ley 14.346 de “Maltrato animal” y la Ley Nacional de Protección de Animales N° 2786, conocida como “Ley Sarmiento”. ¿Cómo denunciar?' },
    { img: '../../assets/animales/img5.jpg', texto: 'Adoptá con Amor y Responsabilidad y siempre tendrás un corazón latiendo por ti, esperándote en casa.' },
    { img: '../../assets/animales/img6.jpg', texto: 'En Argentina, se estima que más del 60% de las mascotas en los hogares son adoptadas.' }
